    ...
    <div>
        ...
        <b-card :class="metadata.job_title.validity && metadata.job_title_alt.validity" no-body class="mt-3 field_container">
            ...
            <div class="px-3 pb-3">
                ...
                <div v-if="!metadata.job_title.value">
        ...
        <b-card :class="metadata.deadline.validity" class="mt-3">
            ...
            <p class="mt-3"><fa :icon="['fas', 'exclamation-circle']" class="text-warning mr-1" size="sm" /> {{ $t('content_meta.application_deadline_timezone') }}</p>
